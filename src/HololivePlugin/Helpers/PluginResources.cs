namespace Loupedeck.HololivePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HololivePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HololivePlugin.Resources.Resource.txt`.
